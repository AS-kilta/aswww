...
Kaikkien yllämainittujen ominaisuuksien toteutus on aloitettu ja useimmat toimivat jo hyvin, joten alkuperäiset vaatimukset pystytään näillä näkymin täyttämään.}
...
Korkean tason arkkitehtuurikuvaus on pysynyt suunnitteluvaiheen jälkeen lähes muuttumattomana. Yksityiskohdat esitetään vasta toteutusdokumentissa, koska ne muuttuvat edelleen usein.}
