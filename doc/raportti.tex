...
\subsection{Vaihtoehtoiset skinit}
Projektiin on jätetty malliksi viimesyksyinen layout, mutta sen toimivuuteen tai validoituvuuteen ei ole kiinnitetty huomiota. Vanhalla skinillä saa kuitenkin testattua konseptin toimivuutta.
...
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{valid_html.png}
\caption{Valid XHTML 1.0}
\label{www.tekniikka}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{valid_css.png}
\caption{Valid CSS 2.1}
\label{www.tekniikka}
\end{figure}
